<%-- 
    Document   : timereserve
    Created on : May 22, 2016, 9:04:14 PM
    Author     : Nikkor50
--%>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Reserve Panels</h2>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Reserve Tabs</h2>
        </div>
        <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Reserve List</h2>
        </div>
        <div class="col-md-4">
            <div class="media">
                <div class="pull-left">
